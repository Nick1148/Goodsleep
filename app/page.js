...
const COUPLE_Q_V2 = [
  "이 질문 답하고 상대에게 뽀뽀 한 번. 몇 초 할래?",
  "기쁠 때 나는 어떤 방식으로 표현해? 상대가 못 알아챌 수도 있는 방식이 있다면?",
  "나는 몇 명 안 되는 사람에게만 마음을 여는데, 상대가 그중 하나라는 걸 알까?",
  "상대가 나를 사랑한다고 느끼는 구체적인 순간은?",
  "내가 노력한 것에 대한 최고의 보상은 무엇이야?",
  "우리가 함께한 밤 중 가장 따뜻했던 기억은?",
  "나를 이해하려고 노력하는 상대에게 하고 싶은 말은?",
  "상대를 위해 내가 노력 중인 것은?",
  "인정받고 싶은 부분을 상대에게 솔직히 말한다면?",
  "내가 감정을 억누르는 게 습관인 것 같아? 언제부터?",
  "'오늘 자고 갈래?' 하면 대답은?",
  "내 무표정이 상대에게 오해를 준 적 있어? 실제론?",
  "감정적인 대화에서 내가 조용해지는 이유는?",
  "상대의 손이 닿았을 때 제일 좋은 곳은?",
  "상대가 나를 기다려준 순간에 대해 어떻게 생각해?",
  "내가 자주 하는 생각 중 상대와 나누고 싶은 것은?",
  "내가 상대의 말에 바로 반응 안 하는 이유는? (생각 중이라서?)",
  "내 감정이 '과하다'고 느낀 적 있어? 실제론?",
  "상대가 혼자 시간이 필요할 때 나는 뭘 하면 좋을까?",
  "오늘 상대를 제일 안고 싶었던 순간은?",
  "상대가 이해 못 해도 내가 계속 하고 싶은 것은?",
  "내가 진심으로 웃는 순간은 어떤 때야?",
  "나에게 '완벽한 하루'는 어떤 모습이야?",
  "상대가 나에게 배웠으면 하는 것 하나는?",
  "내가 상대에게 배려하고 있는데 못 알아채는 것 같은 게 있어?",
  "상대와 함께한 기념일 중 최고는?",
  "상대가 나를 챙겨줄 때 제일 감동한 순간은?",
  "화가 나도 참는 편이야? 그럼 그 감정은 어디로 가?",
  "상대의 이야기를 듣고 있다는 걸 어떻게 보여줄 수 있을까?",
  "상대가 같은 얘기를 반복할 때 내 속마음은?",
  "하루에 원하는 연락의 최소 기준이 있어?",
  "같이 있을 때 대화가 없으면 불편해? 이유는?",
  "상대가 내 노력을 알아줄 때와 모를 때 기분 차이는?",
  "내일 아침 상대를 깨우는 나만의 방법은?",
  "비판을 받으면 나는 어떻게 반응해? 이유는?",
  "혼자 있는 시간이 필요할 때, 상대가 어떻게 해주면 제일 편해?",
  "나의 '해결사' 모드가 상대에게 필요 없을 때가 있다는 걸 알아?",
  "상대가 나를 자랑스러워한다고 느낀 적 있어?",
  "내 표현이 부족해 보였을 때, 실제 마음은 어땠어?",
  "깨물어주고 싶은 상대의 모습은?",
  "'괜찮아'라고 말할 때 정말 괜찮은 거야?",
  "상대의 침묵을 나는 어떻게 해석해? 실제와 다른 것 같아?",
  "상대 앞에서 무너져도 된다고 느끼려면 뭐가 필요해?",
  "상대에게 진심으로 감동받은 순간, 나는 어떻게 반응했어? 속마음은?",
  "상대가 기념일을 챙기길 바랄 때 나는 어떻게 느껴?",
  "우리 둘만의 시크릿 코드가 있다면?",
  "상대의 잠든 얼굴을 보면 뭐 하고 싶어?",
  "상대가 갑자기 뒤에서 안으면?",
  "'조용히 있고 싶다'는 신호를 상대에게 어떻게 보내면 좋을까?",
  "내 감정을 말로 나누는 게 나에게 왜 중요해?",
  "오늘 내 감정 날씨를 상대에게 한 줄로 전한다면?",
  "내 방식으로 상대를 아끼고 있다는 걸 오늘 어떻게 보여줄래?",
  "상대가 제일 사랑스러워 보이는 잠옷은?",
  "상대의 '따로 또 같이'를 나는 어떻게 받아들이면 좋을까?",
  "내가 상대를 '신뢰한다'고 느끼는 기준은?",
  "상대의 말에 '왜?'라고 자주 묻는 이유는?",
  "내가 유튜브/책에서 찾는 건 뭐야?",
  "작은 일에도 반응해주는 게 나에겐 어떤 의미야?",
  "말을 아끼는 이유가 있어? 상대가 어떻게 받아들였으면 해?",
  "내 감정이 무시당했다고 느끼는 순간은?",
  "같이 있을 때 손이 자꾸 가는 곳은?",
  "오늘 상대가 나에게 해준 배려 중 알아챈 것은?",
  "나에게 '함께한다'는 건 어떤 모습이야?",
  "애정표현을 자주 하는 이유는?",
  "연락이 늦을 때 내 머릿속에서 일어나는 일은?",
  "나의 진지함이 상대에게 부담이 될까 걱정한 적 있어?",
  "상대가 내 머리를 쓰다듬으면?",
  "상대에게 내 취미를 설명한다면 왜 그게 좋은지 말해줄래?",
  "내가 상대와 있을 때 시간 감각이 달라지는 순간은?",
  "상대가 감동한 순간과 내가 의도한 순간이 같았어?",
  "상대와 붙어 있으면 잠이 잘 와, 안 와?",
  "이불 속에서 제일 하고 싶은 것은? ㅋㅋ",
  "'그냥 들어줘'라고 말할 때 정확히 어떤 걸 원해?",
  "내가 상대를 특별하게 생각한다는 증거는?",
  "상대가 서운해할 때 내가 속으로 하는 생각은?",
  "내가 상대에게 '고맙다'고 느끼지만 말 못 한 것 3개는?",
  "상대가 즉흥적으로 놀자고 할 때 내가 망설이는 이유는?",
  "혼자 끙끙 앓다가 상대에게 털어놓은 적 있어? 그 뒤 어땠어?",
  "내가 상대를 놓치기 싫다고 느낀 순간은?",
  "우리 둘의 '밤'을 한 단어로 표현하면?",
  "내가 상대에게 표현하는 애정의 크기를 숫자로?",
  "상대가 '설명 안 해도 알아줬으면' 할 때 나는 왜 어려워?",
  "즉흥적인 제안을 받으면 겉으론 어떻게, 속으론 어떻게 반응해?",
  "나의 약점을 상대가 알아도 괜찮다고 느낀 순간이 있었어?",
  "혼자 몰입하는 취미가 나에게 어떤 의미야?",
  "상대가 직설적으로 말할 때 나는 어떻게 느껴?",
  "상대와의 관계에서 내가 배운 것은?",
  "갈등이 생기면 나는 왜 빨리 풀고 싶어해?",
  "독립적인 내가 상대에게 의지하는 부분이 있다면?",
  "둘이 붙어 있을 때 시간이 멈췄으면 하는 순간은?",
  "상대의 가족을 어떻게 대하고 싶어?",
  "오늘 밤 같이 있다면 뭐부터 하고 싶어?",
  "내가 상대의 친구들에게도 잘하는 이유는?",
  "내가 상대 얘기를 기억한다는 걸 보여준 적 있어?",
  "내가 시간을 '낭비했다'고 느끼는 순간은?",
  "감정이 없어 보이는 순간, 사실은 어떤 감정이었어?",
  "상대의 무뚝뚝함을 내가 어떻게 이해하면 좋을까?",
  "같이 잘 때 안고 자 vs 각자 자? 이유는?",
  "안고 있을 때 상대의 심장소리 들어본 적 있어?",
  "상대에게 애정을 표현했는데 반응이 없을 때 기분은?",
  "오늘 상대와 제일 밀착하고 싶은 시간대는?",
  "최근에 깊이 빠져든 생각이 있다면 공유해줄래?",
  "우리가 서로 다르기 때문에 좋은 점은?",
  "눈물이 안 나도 슬플 때가 있어? 그럴 땐 어떻게 해?",
  "'잘했어'라는 말이 나에게 얼마나 중요해?",
  "나를 이해하는 데 필요한 열쇠 하나를 준다면?",
  "분위기를 좋게 만들려고 애쓰는 나를 상대가 알아줄까?",
  "상대의 표현 방식을 존중하면서 내 욕구도 채우는 방법은?",
  "나에게 상대는 어떤 존재인지, 논리 말고 마음으로 말한다면?",
  "상대가 제일 섹시해 보이는 순간은?",
  "내가 상대와 함께 있고 싶은 순간은 언제야?",
  "상대의 감정 기복을 내가 어떻게 받아들이면 좋을까?",
  "내가 약해 보이는 걸 보여주기 힘든 이유는?",
  "문자로 표현하는 게 편해, 직접 말하는 게 편해? 왜?",
  "상대의 손을 잡으면 어디로 데려가고 싶어?",
  "추억을 남기는 게 (사진, 기록) 나에게 어떤 의미야?",
  "오늘 밤 상대에게 굿나잇 키스 대신 하고 싶은 것은?",
  "상대의 반응이 없으면 불안해지는 이유는?",
  "상대가 나를 재워주는 방식 중 제일 좋은 건?",
  "1년 뒤의 나는 상대에게 어떤 사람이고 싶어?",
  "상대가 나에게 배웠으면 하는 점 하나는?",
  "내가 상대에게 배우고 싶은 점 하나는?",
  "같이 목욕/온천 간다면?",
  "고마움을 표현받을 때 어떤 방식이 제일 좋아?",
  "함께하는 시간이 나에게 왜 중요해?",
  "내가 화내는 대신 조용해지는 이유는?",
  "내가 예민해지는 상황과 그때 필요한 것은?",
  "내가 혼자 결정하고 통보하는 것처럼 보일 때, 실제 과정은?",
  "내가 '이해받는다'고 느끼는 순간은?",
  "스트레스받을 때 나는 왜 혼자 처리하려고 해?",
  "상대에게 부탁하는 게 어려운 이유는?",
  "반응이 느린 상대에게 서운하지 않으려면 뭐가 필요해?",
  "작은 인정이 나에게 큰 힘이 되는 이유는?",
  "둘만 있을 때 제일 야한(?) 순간은 언제였어?",
  "도움을 요청하는 게 나에게 왜 어려워?",
  "내 머릿속을 상대가 하루만 볼 수 있다면 뭐가 놀라울까?",
  "내가 감정을 자세히 설명하는 건 왜야?",
  "상대가 폰만 볼 때 나는 어떤 감정이 들어?",
  "혼자 있고 싶은 게 상대가 싫어서가 아니라는 걸 어떻게 설명할 수 있을까?",
  "상대가 나의 '무관심해 보이는 태도'를 견뎌준 것에 대해 하고 싶은 말은?",
  "상대에게 처음으로 '의지'했던 순간은?",
  "혼자 생각하는 걸 즐기는데, 무슨 생각을 주로 해?",
  "'같이 씻을래?' 라는 말에 어떤 반응?",
  "말보다 행동으로 마음을 보여준 적, 상대가 알아챈 것 같아?",
  "내가 '쓸데없다'고 느끼는 것과 '가치 있다'고 느끼는 것은?",
  "내가 사람을 관찰하는 습관이 있는데 상대의 뭘 주로 봐?",
  "상대가 내 세계에 들어왔다고 느낀 순간은?",
  "내가 상대에게 배우고 싶은 것 하나는?",
  "해결책 대신 공감이 필요한 순간을 상대가 어떻게 알 수 있어?",
  "상대가 나를 이해했다고 느낀 최고의 순간은?",
  "나는 왜 약속을 중요하게 여겨? 상대가 어겼을 때 속마음은?",
  "'귀찮아'라고 말할 때 진짜 의미는 뭐야?",
  "상대의 웃는 입술이 제일 예쁜 순간은?",
  "상대의 목소리 중 제일 심쿵하는 톤은?",
  "'내 방식대로 사랑한다'는 것에 대해 상대에게 부탁하고 싶은 것은?",
  "내가 감정을 '분석'하려는 게 상대에겐 어떻게 보일까?",
  "상대와 처음 키스한 날, 그 뒤에 무슨 생각했어?",
  "상대의 손끝이 제일 먼저 닿았으면 하는 곳은?",
  "내가 '이거 봐봐!' 할 때 원하는 반응은?",
  "내가 직설적으로 말할 때 상대를 아프게 할 의도가 없다는 걸 어떻게 전할까?",
  "공감받지 못했다고 느낀 순간, 실제로 원했던 건?",
  "대화 중에 내가 갑자기 다른 주제로 넘어갈 때, 사실 머릿속에선 어떤 연결이 있었어?",
  "감정을 말로 꺼내는 게 어려운 이유를 설명해본다면?",
  "내가 사랑을 느끼는 방식 (말/시간/선물/행동/스킨십) 순위는?",
  "상대에게 '내 방식의 사랑'을 알려준다면 첫 문장은?",
  "상대와 밀착했을 때 제일 편안한 자세는?",
  "내 배려를 알아줬으면 하는 순간은?",
  "내가 바뀌지 않았으면 하는 나의 모습은?",
  "내가 사랑을 표현하는 방식을 상대가 알아챘으면 하는 게 있어?",
  "내가 결정을 내릴 때 상대의 의견은 어떻게 반영돼?",
  "내가 감정을 말로 하면 왜 어색해? 그래도 해보고 싶은 말은?",
  "오늘 상대에게 안기고 싶은 이유 하나만!",
  "키스보다 더 친밀하게 느껴지는 순간은?",
  "선물보다 중요한 게 있다면?",
  "내가 '논리적으로'라고 말할 때 상대는 어떻게 느낄까?",
  "'안아줘' 한마디에 어떤 마음이 들어?",
  "내 얘기를 상대가 기억해줄 때 기분은?",
  "상대의 어떤 점이 나를 안심하게 해?",
  "나는 왜 상대에게 '먼저' 연락을 잘 안 해? 마음과 다른 점이 있어?",
  "애정을 원하는 만큼 못 받을 때 어떻게 해?",
  "'당연한 거 아니야?' 라는 말이 왜 서운해?",
  "상대가 '나한테 관심 없어?'라고 느꼈을 순간, 내 실제 상태는?",
  "힘들 때 상대가 눈치채줬으면 하는 신호는?",
  "애정표현이 자연스러워지려면 나에게 뭐가 필요할까?",
  "완벽주의가 상대와의 관계에 미치는 영향은?",
  "상대의 어떤 부위(?)를 제일 좋아해? 솔직히!",
  "'그냥 들어줘'라는 말이 나에겐 왜 어려워?",
  "상대가 기념일을 잊으면 어떤 감정이 들어?",
  "혼자 여행 vs 둘이 여행, 나에겐 어떻게 달라?",
  "목표를 향해 갈 때 상대가 어떤 역할을 해줬으면 해?",
  "실패했을 때 나는 나 자신에게 어떻게 대해?",
  "나에게 '안정감'은 어떤 모습이야?",
  "깊은 관계와 넓은 관계 중 내가 원하는 건? 이유는?",
  "싸운 뒤 상대가 먼저 다가오면 어떤 기분이야?",
  "울고 싶을 때 상대가 옆에 있으면 어떻게 해줬으면 해?",
  "내가 상대의 말을 '기억'하는 방식은 어떤 거야? (메모? 머릿속?)",
  "내가 주변 사람들을 챙기는 이유는 뭐야?",
  "나에게 '재미'는 어떤 종류야? 상대와 다른 점은?",
  "상대와 있을 때 내가 편안하다는 증거는?",
  "비판과 조언의 차이를 나는 어떻게 생각해?",
  "상대의 표현이 작아도 사랑을 느낄 수 있는 방법은?",
  "기념일이 나에게 중요한 진짜 이유는?",
  "내가 자주 하는 걱정 중 상대와 나누고 싶은 것은?",
  "'내가 잘못했나?' 자주 생각하는 편이야?",
  "상대의 스킨십 중 더 자주 해줬으면 하는 것은?",
  "갈등 후 회복하는 데 나에게 필요한 것은?",
  "내가 배려하는데 상대가 못 알아챈 것 같은 것은?",
  "내 사랑이 커지고 있다는 걸 상대가 어떻게 알 수 있어?",
  "상대 앞에서 나쁜 모습을 보여도 괜찮다고 느끼려면?",
  "내가 세운 장기 계획 중 상대가 모르는 게 있어?",
  "상대가 '나 좋아하는 거 맞아?' 물으면 뭐라고 답하고 싶어?",
  "사람 많은 곳에 다녀온 날 나는 어떻게 회복해?",
  "하루 중 방해받고 싶지 않은 시간대가 있어? 이유는?",
  "'뭐 해?' 라는 물음에 담긴 내 진짜 마음은?",
  "내가 상대의 어떤 모습을 몰래 좋아해?",
  "즉각적인 반응이 나에게 왜 중요해?",
  "상대가 무심코 한 말에 상처받은 적, 어떤 말이었어?",
  "불 끄고 누워서 제일 먼저 하고 싶은 말은?",
  "오늘 상대에게 스킨십으로 마음 전한다면 어떤 방식으로?",
  "오늘 밤 상대에게 보내고 싶은 마지막 메시지는?",
  "내가 사람에게 정을 주는 방식은 어떤 거야?",
  "상대가 나의 진지함을 좋아해줄 때 기분은?",
  "내 기분을 알아채주는 사람이 왜 특별해?",
  "내가 사랑받고 있다고 확신하는 순간은 언제야?",
  "우리가 다른 게 오히려 좋다고 느낀 순간은?",
  "키스할 때 제일 설레는 순간은?",
  "내 말투가 차갑게 느껴진 적 있어? 그때 실제 감정은?",
  "내가 뭔가를 챙겨줬을 때 상대의 어떤 반응이 기뻐?",
  "오늘 상대의 어디에 손을 얹고 싶어?",
  "'사랑해'라는 말을 자주 듣고 싶은 이유는?",
  "우리만의 전통을 만들고 싶은 이유는?",
  "미래를 자주 생각하는 게 현재의 상대에게 소홀해 보일까 걱정된 적 있어?",
  "기분이 안 좋을 때 상대의 어떤 말이 위로가 돼?",
  "내가 제일 두려워하는 관계의 순간은?",
  "오늘 상대에게 듣고 싶은 말 딱 하나는?",
  "같이 자고 일어난 아침, 제일 좋은 순간은?",
  "상대가 나를 진짜로 이해했다고 느낀 순간이 있어?",
  "상대가 나를 만질 때 제일 좋은 방식은?",
  "상대의 향기 하면 떠오르는 기억은?",
  "관계에서 내가 절대 타협 못 하는 것은?",
  "특별한 날 상대에게 바라는 최소한의 것은?",
  "내가 챙김받고 싶은 방식은 어떤 거야?",
  "상대의 비합리적으로 보이는 선택을 존중하려면 나에게 뭐가 필요해?",
  "상대와 '싸움'이 아니라 '토론'을 하고 싶을 때 어떻게 구분해?",
  "내가 상대의 하루에 대해 안 물어보는 것 같을 때, 실제로는?",
  "다른 사람 걱정하느라 나를 못 챙긴 적 있어?",
  "계획이 틀어졌을 때 내 머릿속에선 무슨 일이 일어나?",
  "나의 5년 계획에 상대는 어디에 있어?",
  "상대와 눈 마주칠 때 제일 설레는 상황은?",
  "상대 없이도 잘 사는 것처럼 보이지만 실제론?",
  "남을 먼저 생각하다 지친 날, 상대에게 원하는 건?",
  "상대가 그냥 '같이 있어줘'라고 하면 나는 어떻게 해?",
  "상대가 나를 오해했을 때 내가 하는 행동은?",
  "오늘 밤 꿈에서 상대와 뭐 하고 싶어?",
  "상대와 같이 하면 좋을 것 같은 나의 관심사는?",
  "'내가 다 해줄게'라고 하는 마음의 이유는?",
  "내가 상대의 손을 먼저 잡는 순간은 어떤 마음이야?",
  "상대에게 내 세계를 열어주고 싶은 부분은?",
  "내가 상대를 지키고 싶다고 느끼는 방식은?",
  "나의 세계를 상대와 나누고 싶은 부분은?",
  "무뚝뚝해 보이는 순간에도 상대 생각을 하고 있다는 걸 어떻게 알려줄까?",
  "목표 달성 중일 때 상대의 어떤 말이 힘이 돼?",
  "내가 상대의 감정을 먼저 살피는 이유는?",
  "완벽하게 준비되기 전엔 시작 안 하는 편이야? 상대는 어떻게 느낄까?",
  "내가 관심 있는 주제를 상대가 물어봐주면 어떤 기분이야?",
  "내가 폰만 보고 있을 때 사실 뭐 하고 있어?",
  "상대의 옷차림 중 제일 심장 뛰게 하는 건?",
  "토론하듯 대화하는 게 나에겐 애정의 표현일 수 있다는 걸 상대가 알까?",
  "혼자 생각 정리하는 시간이 상대와의 관계에 어떤 도움이 돼?",
  "기록하고 추억하는 습관이 나에게 주는 것은?",
  "'착한 사람'으로 사는 게 힘들 때는?",
  "위로가 필요할 때 나는 어떤 위로를 원해? (조언 vs 공감)",
  "남 눈치 보느라 나를 잃은 적 있어?",
  "상대의 어떤 냄새가 제일 좋아? (샴푸/향수/그냥 살냄새?)",
  "상대에게 '오늘 예뻐/멋져'라고 말할 타이밍은?",
  "나 자신을 챙기는 게 어색한 이유는?",
  "가족과 친구를 챙기는 게 상대에게 어떻게 보일까 걱정돼?",
  "내가 상대에게 마음을 열었다는 걸 증명할 사건 하나는?",
  "상대와 다투기 싫어서 말 안 한 게 있다면?",
  "상대의 목소리로 자장가 듣고 싶어?",
  "상대의 몸 중 나만 아는 특징은? ㅋㅋ",
  "상대의 짧은 답장을 어떻게 받아들여?",
  "상대에게 오늘 꼭 해주고 싶은 스킨십 하나는?",
  "침대에서 제일 좋아하는 포지션은? (잘 때 말이야 ㅋㅋ)",
  "상대의 칭찬 중 제일 오래 남는 말은?",
  "내 안의 감정이 겉으로 나오기까지 얼마나 걸려?",
  "거절을 잘 못 하는 이유가 있다면?",
  "'그냥 아무거나'가 나에게 왜 어려운 대답이야?",
  "'사랑해' 대신 나는 어떤 행동으로 마음을 전해?",
  "상대가 챙겨준 작은 이벤트 중 기억나는 것은?",
  "키스하고 싶어지는 상대의 행동은?",
  "상대의 사랑 표현 중 제일 와닿는 것은?",
  "상대에게 귓속말로 하고 싶은 말은?",
  "스킨십으로 사랑을 확인하고 싶은 순간은?",
  "상대가 나에게 애정을 '확인'받고 싶어할 때 어떻게 느껴?",
  "목/귀/손 중 제일 약한 곳은?",
  "혼자 있는 시간에 나는 어떤 감정이야?",
  "상대가 나를 유혹한다면 뭐가 통할까?",
  "상대의 입술에 대해 한마디?",
  "상대와 함께 만들고 싶은 우리만의 방식은?",
  "상대와 나의 관계를 한 문장으로 정의한다면?",
  "친구 모임보다 둘이 있는 게 편한 이유가 있다면?",
  "상대의 등을 만질 때 vs 상대가 내 등을 만질 때?",
  "상대가 나의 세계관을 물어보면 어디부터 설명할래?",
  "주말에 아무 계획 없이 쉬는 게 나한텐 어떤 의미야?",
  "서로에게 '오늘 밤' 원하는 것 한 줄?",
  "내 방식으로 사랑받고 싶다고 말한다면 첫 문장은?",
  "상대가 먼저 연락해줄 때 어떤 기분이야?",
  "내가 하는 '최적화'가 상대에게 피곤하게 느껴질 수 있다는 걸 알아?",
  "상대를 위해 몰래 챙긴 것들이 있다면?",
  "스킨십 중 제일 좋아하는 건? (손잡기/포옹/키스/그 이상?)",
  "내가 상대에게 '설명'보다 '표현'을 하고 싶은 순간은?",
  "상대가 나의 감정을 '분석'하려 할 때 기분은?",
  "연락이 뜸할 때 사실 뭘 하고 있는 거야?",
  "상대가 하루 얘기를 다 들어주면 나는 어떤 기분이야?",
  "내가 상대의 감정을 못 따라갈 때 원하는 도움은?",
  "상대가 '뭐 해?' 물을 때 짧게 답하는 이유는?",
  "오늘 상대에게 받은 애정 중 제일 좋았던 것은?",
  "내가 상대를 위해 포기한 나의 원칙이 있다면?",
  "상대가 나를 '차갑다'고 느꼈다면 실제 온도는 몇 도야? ㅋㅋ",
  "상대와 감정을 나눈 뒤 나에게 생기는 변화는?",
  "내가 관계에서 제일 두려운 것은?",
  "내가 하루 종일 조용해도 사랑이 줄어든 게 아니라는 걸 어떻게 알려줄까?",
  "사소한 날도 기념하고 싶은 마음은 어디서 와?",
  "상대가 낮은 목소리로 이름 부르면?",
  "내가 상대에게 화가 났을 때 보이는 신호는?",
  "내가 리액션이 작은 건 관심이 없어서야, 원래 그래?",
  "둘만의 시간에 제일 로맨틱했던 밤은?",
  "계획을 미리 공유하지 않는 이유가 있다면?",
  "상대가 나를 안을 때 어떤 느낌이야?",
  "상대에게 내가 원하는 것을 명확히 말하는 연습, 오늘 해본다면?",
  "'같이 있지만 각자 할 일 하기'는 나에게 어떤 느낌이야?",
  "오늘 내가 상대를 생각한 횟수를 솔직히 말한다면?",
  "칭찬을 어색해하는 상대에게 원하는 최소한의 표현은?",
  "내 감정을 상대가 다 이해 못 해도 괜찮다고 느끼려면?",
  "상대에게 기대고 싶은 순간이 있었는데 못 한 적 있어?",
  "내가 '괜찮은 척'할 때 상대가 어떻게 해주면 좋겠어?",
  "자존심 때문에 사과를 미룬 적 있어?",
  "상대에게 몰래 설렜던 최근 순간은?",
  "키스 후 상대의 표정을 본 적 있어? 어땠어?",
  "에너지가 바닥났을 때 상대에게 원하는 건 위로야, 거리야?",
  "나의 침묵을 상대가 어떻게 읽어줬으면 해?",
  "상대의 첫 스킨십, 심장 몇 번 뛰었어?",
  "일정이 정해지지 않으면 불안한 편이야? 상대가 어떻게 도와줄 수 있어?",
  "데이트를 미리 계획하는 게 나에겐 어떤 의미야?",
  "상대와 함께 세우고 싶은 장기 목표가 있어?",
  "상대에게 뽀뽀하고 싶은 곳은?",
  "소셜 배터리가 방전됐다는 걸 상대가 어떻게 알아챌 수 있어?",
  "'평생'이라는 말을 쉽게 안 하는 이유가 있다면?",
  "상대가 걱정할까 봐 말 안 한 게 있어?",
  "내가 '비효율적'이라고 느끼는 상대의 행동과 그래도 괜찮은 이유는?",
  "상대가 감정을 말할 때 나는 왜 바로 해결책부터 말해?",
  "내가 상대에게 '확인'을 자주 하는 이유는?",
  "상대에게 진짜 내 모습을 보여준 첫 순간은?",
  "내가 진짜 원하는 걸 상대에게 말하기 어려운 이유는?",
  "내가 상대와 다투고 나서 혼자 정리하는 시간은 얼마나 필요해?",
  "내가 좋아하는 조용한 데이트는?",
  "계획대로 안 됐을 때 상대가 해주면 좋은 말은?",
  "오늘 상대에게 하고 싶은 스킨십 하나는?",
  "상대와 의견이 다를 때 내가 원하는 대화 방식은?",
  "고맙다는 말보다 더 진심인 나만의 표현은?",
  "내가 깊이 파고드는 것들의 공통점은?",
  "상대와 의견이 다를 때 내가 양보하는 이유는?",
  "내가 관계에서 성장했다고 느끼는 부분은?",
  "내가 편안함을 느끼는 걸 상대는 어떻게 알 수 있을까?",
];
const qForDate = (d) => {
  if (d >= "2026-09-14") return COUPLE_Q_V2[dayOfYear(d) % COUPLE_Q_V2.length]; // v2: 서로 이해하기 (INTJ 50 / ESFJ 30 / 끈적 20)
